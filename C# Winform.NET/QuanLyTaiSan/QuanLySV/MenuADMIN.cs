...
namespace QuanLySV
{
    public partial class MenuADMIN : Form
    {
        ...
        private void btSoGiaoDich_Click(object sender, EventArgs e)
        {
            ...
            SoGiaoDich fr = new SoGiaoDich(IDUser,0) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
        ...
        {
            panelMenu.Controls.Clear();
            SoGiaoDich fr = new SoGiaoDich(IDUser,1) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            panelMenu.Controls.Add(fr);
            fr.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            fr.Dock = DockStyle.Fill;
            fr.Show();
        ...
        {
            panelMenu.Controls.Clear();
            LapKeHoach fr = new LapKeHoach() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            panelMenu.Controls.Add(fr);
            fr.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
            fr.Dock = DockStyle.Fill;
            fr.Show();
