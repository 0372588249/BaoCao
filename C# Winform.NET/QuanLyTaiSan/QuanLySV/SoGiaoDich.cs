...
namespace QuanLySV
{
    public partial class SoGiaoDich : Form
    {
        ...
        public SoGiaoDich(string id,int loai)
        {
            InitializeComponent();
            IDUser = id;
            loaiForm = loai;
        ...
        void loadForm()
        {
            ...
            ChiTietSoGiaoDich fr = new ChiTietSoGiaoDich(IDUser, idWallet, loaiForm) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
